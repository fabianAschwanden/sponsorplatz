...
| Payment | `PaymentProvider` | `anfrage` (Datatrans/Stub) | — geplant | Port vorhanden, Package-Trennung offen |
...
- [`specs/TESTSTRATEGIE.md`](../../specs/TESTSTRATEGIE.md) §Architektur-Verifikation (ARCH-20)
